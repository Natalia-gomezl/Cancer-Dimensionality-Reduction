...
#PROYECTO: Reducción de Dimensionalidad en Cáncer (TCGA)
# SCRIPT: Análisis de Componentes Principales (PCA)
# 
# CRÉDITOS DE AUTORÍA:
#   - Autor original: Profesor de la asignatura de Algoritmos e 
#     Inteligencia Artificial (BIOINF).
#   - Adaptación y documentación: Natalia Gómez
#
# DESCRIPCIÓN:
#   Este script realiza la carga, preprocesamiento y visualización 
#   de datos de RNA-seq utilizando el método paramétrico lineal PCA.
#   El objetivo es identificar clústeres genéticos en 5 tipos de tumores.
##########################################################################
